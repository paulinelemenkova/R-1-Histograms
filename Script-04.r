...
p04<-ggplot(dat04, aes(X04)) +
  ...
  scale_x_continuous(breaks = pretty(dat04$X04, n = 4), minor_breaks = seq(min(dat04$X04), max(dat04$X04), by = 500)) +
  ...
  stat_density(geom = "line", size = .3, aes(color = "density")) +
	     ...
	     geom_vline(aes(color = "norm_dist", xintercept = dnorm(X04)), lty = 2, size = .3)
p04
